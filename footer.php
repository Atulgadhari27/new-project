    ...
    <div class="dark">
        <div class="container animate-box" id="footer">
            <div class="row">
                <div class="col-sm-6"> 
                    <div><a class="nsavbar-brand" href="#">RentMyHouse</a></div>
                    <br>
                    <div class="text-white">Get amazing results working with the best programmers, designers, writers
                        and
                ...
                <div class="col-sm-6">
                    <div class="icons ">Explore Our Pages</h3>
                    </div>
                    <br>
                    <table width="100%">
                        <tr>
                            <td><a class="text-white" href="#!">Home</a></td>
                            <td><a class="text-white" href="#">Hosting</a></td>
                        </tr>
                        <tr>
        ...
        <div class="container" id="fh5co-legal">
            <div class="row">
                <div class="col-sm-8 text-white mtext-center">
                    &copy; 2021 <a class="text-gr" href="#">RentMyHouse</a>.
                    Design
                    by <a href="#" target="_blank">RentMyHouse</a>.
                </div>
