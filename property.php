                ...
                <?php 
                    if(isset($_SESSION["email"])){
                        if (mysqli_num_rows($query2)>0) {
                            echo '<h3>This Property has been already booked</h3>';
                        }
                        else{
                            echo '<h3>Loved the property,<a class = "orange text-decoration-none fs-25" href="booking.php?House_No='.$House_No.'">BOOK NOW</a></h3>';
                        }
                    }
                    else{
                        echo '<h3>Loved the property,TRY <a href="" class="orange text-decoration-none fs-25" data-toggle="modal" data-target="#login">LOGGING IN</a> TO BOOK</h3>';
                    }
                        ?>
                </div>
        </div>
